...
import com.music.spotui.ui.screens.DeveloperConsoleScreen
import com.music.spotui.ui.screens.UpdateRoadmapScreen
...
//    player = ExoPlayer.Builder(context).build()
    ...
    NavHost(
        ...
        composable(Routes.DeveloperConsole.route){
            DeveloperConsoleScreen(navHostController)
        }
        composable(Routes.UpdateRoadmap.route){
            UpdateRoadmapScreen(navHostController)
        }
