...
sealed class Routes(
    ...
    object Downloads : Routes(icon = R.drawable.ic_download, label = "Downloads", route = "downloads")
    object Category : Routes(0, "Category", "category")
    object Login : Routes(0, "Login", "login")
    object Settings : Routes(icon = R.drawable.ic_settings, label = "Settings", route = "settings")
    object DeveloperConsole : Routes(0, "DeveloperConsole", "dev_console")
    object UpdateRoadmap : Routes(0, "UpdateRoadmap", "update_roadmap")
